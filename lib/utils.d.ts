...
export declare function resolvePath(mainPath: any, ...args: any[]): string;
...
export declare const checkImageLogType: (testReporter: ITestReporter, logImageType: LogImageType) => boolean;
