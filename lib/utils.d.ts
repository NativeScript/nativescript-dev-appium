...
export declare const prepareDevice: (args: INsCapabilities, deviceManager: IDeviceManager) => Promise<IDeviceManager>;
export declare const prepareApp: (args: INsCapabilities) => Promise<void>;
